...
FunctionsToExport = 'Compress-ArchiveFolder', 'Invoke-CpuArtificialWorkload',
               ...
               'Get-CleanErrorString', 'Invoke-GenericMethod', 'Get-Hash',
               'Add-HashtableItem', 'Remove-HashtableItem', 'Set-HashTableItem',
               'Add-PerformanceRecord', 'Complete-PerformanceRecord',
               'Get-PerformanceRecord', 'Get-PerformanceStore',
               'Get-ObjectModelValue', 'Set-ObjectModelValue',
               'Test-ObjectModelPathIsSafe', 'Add-MemberIfNotExist',
               'ConvertTo-Array', 'ConvertTo-FlatObject', 'ConvertTo-Hashtable',
               'ConvertTo-HashtableBased', 'Edit-ConvertDateTimePropertyToString',
               'Remove-Property', 'Add-PSSessionEntry',
               'Initialize-PSSessionVariable', 'Test-PSSessionEntry',
               'ConvertTo-AesKey', 'Test-SecureStringEmpty', 'Get-NullIf',
