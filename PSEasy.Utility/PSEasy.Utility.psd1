...
FunctionsToExport = 'Compress-ArchiveFolder', 'Invoke-CpuArtificialWorkload',
               ...
               'Get-CleanErrorString', 'Set-ErrorView', 'Invoke-GenericMethod',
               'Get-Hash', 'Add-HashtableItem', 'Remove-HashtableItem',
               'Set-HashTableItem', 'Add-PerformanceRecord',
               'Complete-PerformanceRecord', 'Get-PerformanceRecord',
               'Get-PerformanceStore', 'Get-ObjectModelValue',
               ...
               'Add-PSSessionEntry', 'Initialize-PSSessionVariable',
               'Test-PSSessionEntry', 'ConvertTo-AesKey', 'Test-SecureStringEmpty',
               'Get-NullIf', 'Get-NullIfDBNull', 'Format-Xml',
               ...
               'Test-Script', 'Test-UserPrivilegeAdmin'
