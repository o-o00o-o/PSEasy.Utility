...
FunctionsToExport = 'Compress-ArchiveFolder', 'Invoke-CpuArtificialWorkload',
               ...
               'Get-PerformanceStore', 'Measure-Command2', 'Get-ObjectProperty',
               'Get-ObjectPropertyValue', 'Get-ObjectTokenPath', 'Merge-Object',
               'Set-ObjectProperty', 'Test-ObjectPropertyPathIsSafe',
               ...
               'Invoke-DotInclude', 'Test-ContentNoPassword', 'Test-ContentNoTab',
               'Get-FileLockProcess', 'Test-FileLock', 'Find-Item',
               'Rename-FileWithRegex', 'Rename-GitFileWithRegex', 'Get-LogPath',
               'Remove-Log', 'Start-Logging', 'Stop-Logging', 'Get-Assembly',
               'Build-Module', 'Get-ModuleUserFolder', 'Get-ModuleVersion',
               'Install-ModuleFromFolder', 'Invoke-ModuleFunction',
               'Set-ModuleVersion', 'Uninstall-ModuleFromFolder',
               'Add-ModuleManifestExport', 'Test-Script', 'Invoke-CommandAs',
               'Invoke-PwshAs', 'Invoke-RunAs', 'Start-Impersonate',
               'Stop-Impersonate', 'Test-UserPrivilegeAdmin'
