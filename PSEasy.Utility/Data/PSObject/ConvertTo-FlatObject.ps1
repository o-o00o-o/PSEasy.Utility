Function ConvertTo-FlatObject {
    ...
    .PARAMETER LeavesOnly
        Removes any parent objects of children
...
[Diagnostics.CodeAnalysis.SuppressMessageAttribute(
    <#Category#>'PSUseApprovedVerbs', <#CheckId#>'', Scope='Function',
    Justification = 'not our code'
)]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute(
    <#Category#>'PSAvoidUsingCmdletAliases', <#CheckId#>'', Scope='Function',
    Justification = 'not our code'
)]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute(
    <#Category#>'PSReviewUnusedParameter', <#CheckId#>'', Scope='Function',
    Justification = 'not our code - they are used in the internal functions'
)]
    [CmdletBinding()]
    param(
    ...
    Begin
    {
        ...
        #region FUNCTIONS
            ...
            Function Recurse-Object {
                ...
                # if we had some children, now remove the parent
                if ($LeavesOnly) {
                    $Output.PSObject.Members.Remove($path)
                }
                $Output
            }
